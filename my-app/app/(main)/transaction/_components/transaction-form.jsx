...
// inn {props} ki vajah se accounts and categories props ayenge
// toh iss liye ham account and data base dono mil paa rahe hai 
const AddTransactionForm = ({
  ...
  useEffect(()=>{
    if(transactionResult?.success && !trasactionLoading){
      toast.success(
        editMode
  ...
  },[transactionResult,trasactionLoading,editMode]);
