...
export default function Home() {
  return (
    <div className="mt-32 bg-white">
      ...
      {/* CTA Section */}
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-indigo-500 to-cyan-400">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            ...
            smarter with <span className="font-semibold">BudgetPing</span>.
          </p>
